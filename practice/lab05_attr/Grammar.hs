...
happyExpList = Happy_Data_Array.listArray (0,9) ([32,1024,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseList","aLst","Atom","int","%eof"]
...
action_2 (7) = happyAccept
action_2 _ = happyFail (happyExpListPerState 2)

action_3 (6) = happyShift action_4
action_3 (4) = happyGoto action_5
...
happyReduction_3 (HappyTerminal (T_Int happy_var_1))
	 =  HappyAbsSyn5
		 (Int happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	T_Int happy_dollar_dollar -> cont 6;
	_ -> happyError' ((tk:tks), [])
	}
