...
alex_table = listArray (0 :: Int, 767)
  [ 0
  , 18
  , 18
  , 18
...
alex_check = listArray (0 :: Int, 767)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_0 = \s -> T_Define
alex_action_1 = \s -> T_Int (read s :: Int)
alex_action_2 = \s -> T_Id (s)
alex_action_3 = \s -> T_True 
alex_action_4 = \s -> T_False
alex_action_5 = \s -> T_Plus
alex_action_6 = \s -> T_Minus
alex_action_7 = \s -> T_Multi
alex_action_8 = \s -> T_Divid
alex_action_9 = \s -> T_LParen
alex_action_10 = \s -> T_RParen
